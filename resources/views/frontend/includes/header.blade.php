...
<div class="banner-area banner-area-ptb">
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="banner-img-two" data-aos="fade-up" data-aos-delay="900" data-aos-duration="1000"
                    data-aos-once="true">
                    <img src="{{asset('frontend/images/home-two/home-two.png')}}" alt="Man" />
                    <div class="bg-shape">
                        <img src="{{asset('frontend/images/home-two/home-shape.png')}}" alt="Shape" />
                    </div>
                </div>
            </div>
        </div>
